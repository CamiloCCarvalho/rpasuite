...
class PostgreSQLAdapter(DatabaseAdapter):
    ...
    def connect(self) -> Any:
        try:
            ...
            raise DatabaseError(f"Failed to connect to PostgreSQL: {str(e)}.") from e
    ...
    def _execute_query_impl(self, query: str, params: tuple | None = None) -> Any:
        try:
            ...
            raise DatabaseError(f"Failed to execute PostgreSQL query: {str(e)}.") from e
    ...
    def _execute_many_impl(self, query: str, params_list: list[tuple]) -> None:
        try:
            ...
            raise DatabaseError(f"Failed to execute PostgreSQL executemany: {str(e)}.") from e
    ...
    def get_last_insert_id(self, cursor: Any, table_name: str) -> int:
        ...
        try:
            cursor.execute(f"SELECT CURRVAL(pg_get_serial_sequence('{validated_name}', 'id'))")
